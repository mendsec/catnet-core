...
// ScanConcurrency defines the maximum number of concurrent TCP connections per IP.
const ScanConcurrency = 10

// ScanPorts scans a list of ports on an IP concurrently and returns the results via a channel.
